...
public class UserController {
    ...
    public UserController(UserRepositary userRepositary, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, RoleRepository roleRepository, JwtTokenProvider jwtTokenProvider) {
